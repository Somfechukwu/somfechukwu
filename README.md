...
Over the past few years, I have built practical skills around **SIEM platforms like Splunk**, **deep packet inspection**, **incident response workflows**, and **Python scripting** for security tasks, while actively studying for **CompTIA Security+**.

Lately, I have been integrating **AI** into my daily lab practice. I use it mainly to speed up script writing, test detection logic, and make sense of messy logs. It helps me stay curious, cut down on repetitive work, and work more efficiently. To me, it is just another practical tool that helps me solve problems quicker and keep up with new tech.

> *If you are building a Tier 1 team and want someone who is technically prepared, easy to train, and focused on spot-on threat analysis, let's have a conversation.*

---

## 🛠️ Technical Toolkit & Security Stack

| Domain | Tools & Technologies |
| :--- | :--- |
| **SIEM & Log Analysis** | Splunk, Linux Syslog, Windows Event Logs |
| **Network Security & DPI** | Wireshark, TShark, TCPDump, Suricata, Zeek |
| **Automation & Scripting** | Python 3, Bash, Regex, Scapy |
| **Threat Frameworks** | MITRE ATT&CK, Cyber Kill Chain, NIST CSF |
| **Environments & OS** | Kali Linux, Ubuntu, Windows Server, VirtualBox |
